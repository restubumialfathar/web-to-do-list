    ...
    <div class="container">
        ...
        <div class="card shadow bg-body-teriary rounded mb-4">
            <div class="card-body">
                ...
                <a href="index.php" type="button" class="btn-close me-2 mt-1" disabled aria-label="Close"></a>
                    <input class="form-control me-2" name="title_note" placeholder="JUDUL..." value="<?php echo $result['title_note']; ?>">
                    <input class="form-control me-2" name="note_note" placeholder="WRITE HERE..." value="<?php echo $result['note_note']; ?>">
